...
public final class ProjectIsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.assign_1.OwnersRequest,
      com.assign_1.XML> getGetCarsXmlMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getCarsXml",
      requestType = com.assign_1.OwnersRequest.class,
      responseType = com.assign_1.XML.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.assign_1.OwnersRequest,
      com.assign_1.XML> getGetCarsXmlMethod() {
    io.grpc.MethodDescriptor<com.assign_1.OwnersRequest, com.assign_1.XML> getGetCarsXmlMethod;
    if ((getGetCarsXmlMethod = ProjectIsGrpc.getGetCarsXmlMethod) == null) {
      synchronized (ProjectIsGrpc.class) {
        if ((getGetCarsXmlMethod = ProjectIsGrpc.getGetCarsXmlMethod) == null) {
          ProjectIsGrpc.getGetCarsXmlMethod = getGetCarsXmlMethod =
              io.grpc.MethodDescriptor.<com.assign_1.OwnersRequest, com.assign_1.XML>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getCarsXml"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.assign_1.OwnersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.assign_1.XML.getDefaultInstance()))
              .setSchemaDescriptor(new ProjectIsMethodDescriptorSupplier("getCarsXml"))
              .build();
        }
      }
    }
    return getGetCarsXmlMethod;
  }
  ...
  public static abstract class ProjectIsImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getCarsXml(com.assign_1.OwnersRequest request,
        io.grpc.stub.StreamObserver<com.assign_1.XML> responseObserver) {
      asyncUnimplementedUnaryCall(getGetCarsXmlMethod(), responseObserver);
    }
  ...
  public static final class ProjectIsStub extends io.grpc.stub.AbstractStub<ProjectIsStub> {
    ...
    public void getCarsXml(com.assign_1.OwnersRequest request,
        io.grpc.stub.StreamObserver<com.assign_1.XML> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetCarsXmlMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ProjectIsBlockingStub extends io.grpc.stub.AbstractStub<ProjectIsBlockingStub> {
    ...
    /**
     */
    public com.assign_1.XML getCarsXml(com.assign_1.OwnersRequest request) {
      return blockingUnaryCall(
          getChannel(), getGetCarsXmlMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class ProjectIsFutureStub extends io.grpc.stub.AbstractStub<ProjectIsFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.assign_1.XML> getCarsXml(
        com.assign_1.OwnersRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getGetCarsXmlMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_CARS = 0;
  private static final int METHODID_GET_CARS_XML = 1;
      ...
      switch (methodId) {
        case METHODID_GET_CARS:
          serviceImpl.getCars((com.assign_1.OwnersRequest) request,
              (io.grpc.stub.StreamObserver<com.assign_1.Reply>) responseObserver);
          break;
        case METHODID_GET_CARS_XML:
          serviceImpl.getCarsXml((com.assign_1.OwnersRequest) request,
              (io.grpc.stub.StreamObserver<com.assign_1.XML>) responseObserver);
          break;
        default:
